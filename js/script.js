...
//My Picture opacity
ScrollReveal().reveal('.my-pic', {distance: 0, opacity: 0,duration: 2500, delay: 500});

// My Projects Preset Reveal Animation
ScrollReveal().reveal('.project1', slideRight);
ScrollReveal().reveal('.project2', {delay: 500, distance: '50%', origin: 'top', duration: 1500, opacity: 0});
ScrollReveal().reveal('.project3', {delay: 800, distance: '50%', origin: 'bottom', duration: 1500, opacity: 0});
ScrollReveal().reveal('.project4', {delay: 1200, distance: '50%', origin: 'right', duration: 1500, opacity: 0});
// <-------------------------------------------------------------
